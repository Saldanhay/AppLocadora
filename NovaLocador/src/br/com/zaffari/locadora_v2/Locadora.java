...
import br.com.zaffari.locadora_v2.Cliente.StatusEnum;
...
public static void main(String[] args) {
	...
	Filme oMandaloriano = new Filme("O mandaloriano", GenerosEnum.Ação, "2019");
	...
	oMandaloriano.adicionarCliente("Sergio Ramos", new Cliente("1","Sergio Ramos"));
	
	//LocalDate RetiradaFilme = LocalDate.parse("2023, 05, 10");
	
	Filme JohnWick4 = new Filme("John Wick 4: Baba Yaga", GenerosEnum.Ação, "2023");
	...
	JohnWick4.adicionarCliente("2", new Cliente("2","Darwin Nunes"));
	JohnWick4.adicionarCliente("1", new Cliente("1","Sergio Ramos"));
	
	Filme MisterioNoMediterraneo = new Filme("Mistério no Mediterrâneo", GenerosEnum.Comédia, "2019");
	...
	MisterioNoMediterraneo.adicionarCliente("4",new Cliente("4","Rafael Leão"));
	
	Filme MisterioEmParis = new Filme("Mistério em Paris", GenerosEnum.Comédia, "2023");
	...
	MisterioEmParis.adicionarCliente("5",new Cliente("5","João Alfredo"));

	Filme ComoEuEraAntesdeVoce = new Filme("Como eu era antes de você", GenerosEnum.Romance, "2016");
	...
	ComoEuEraAntesdeVoce.adicionarCliente("6", new Cliente("6","Erick Axe"));
	
	Filme SimplesmenteAcontece = new Filme("Simplesmente acontece", GenerosEnum.Romance, "2014");
	...
	SimplesmenteAcontece.adicionarCliente("7", new Cliente("7","Erick Axe"));

	Filme NadaDeNovoNoFront = new Filme("Nada de novo no front", GenerosEnum.Drama, "2022");
	...
	NadaDeNovoNoFront.adicionarCliente("8", new Cliente("8","Eduardo Schineider"));

	Filme ABatalhaEsquecida = new Filme("A batalha esquecida", GenerosEnum.Drama, "2020");
	...
	Filme CampoDoMedo = new Filme("Campo do medo", GenerosEnum.Terror, "2019");
	...
	Filme M3GAN = new Filme("M3GAN", GenerosEnum.Terror, "2022");
	...
	M3GAN.adicionarCliente("9", new Cliente("9","Emily Dare"));

	Filme BladeRunner2049 = new Filme("Blade Runner 2049", GenerosEnum.Ficção, "2017");
	...
	BladeRunner2049.adicionarCliente("10" , new Cliente("10","Lara Martinez"));
	
	Filme Duna = new Filme("Duna", GenerosEnum.Ficção, "2021");
	...
	do {
		...
		case "8":
			...
			escolha = sc.next();
			resultido = locacao.pesquisaPorCPF(escolha);
			System.out.println(resultido);
